...
OBJS=main.o	shader_loader.o	renderer.o bspline_surface.o mouse_handler.o \
imgui.o imgui_impl_opengl3.o imgui_impl_glfw.o imgui_draw.o imgui_widgets.o

main: $(OBJS)
	$(CXX) $(CXXFLAGS) -o main $(OBJS) $(LDLIBS)

main.o:	main.cpp shader_loader.hpp renderer.hpp imgui/imgui.h imgui/imgui_impl_opengl3.h imgui/imgui_impl_glfw.h
	$(CXX) $(CXXFLAGS) -c main.cpp

shader_loader.o: shader_loader.cpp
	$(CXX) $(CXXFLAGS) -c shader_loader.cpp

renderer.o: renderer.cpp bspline_surface.hpp imgui/imgui.h
